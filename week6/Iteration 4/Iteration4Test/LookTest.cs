...
namespace Iteration4
{
    ...
    public class TestLook
    {
        ...
        {
            Assert.That(look.Execute(player, ["look", "at", "plate"]), Is.EqualTo($"I can't find the plate"));
        }
        ...
        public void TestLookAtNoShieldInBag()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(look.Execute(player, ["look", "at", "shield", "in", "bag"]), Is.EqualTo("I can't find the shield in the leather bag"));
                Assert.That(look.Execute(player, ["look", "at", "potion", "in", "bag"]), Is.EqualTo("I can't find the potion in the leather bag"));
            });
        }
        [Test]
